...
namespace CleanArchitecture.Application.UnitTest.Features.Streamers.Commands.CreateStreamer
{
    public class CreateStreamerCommandHandlerXUnitTests
    {
        ...
        [Fact]
        public async Task CreateStreamerCommand_InputStreamer_RetursNumber()
        {
            var streamerInput = new CreateStreamerCommand
            {
                Nombre = "JosiasStreaming",
                Url = "https://josiasstreaming.com",
            };
